        ...
        return args -> {
            Account teacher = accountRepository.findByUsername("teacher_m2")
                    .orElseGet(() -> {
                        ...
                        account.setPassword(passwordEncoder.encode("Teacher@123"));
            ...
            Account student = accountRepository.findByUsername("student_m2")
                    .orElseGet(() -> {
                        ...
                        account.setPassword(passwordEncoder.encode("Student@123"));
            ...
            Account parent = accountRepository.findByUsername("parent_m2")
                    .orElseGet(() -> {
                        ...
                        account.setPassword(passwordEncoder.encode("Parent@123"));
            ...
            if (chapterRepository.count() == 0) {
                ...
                chapter1.setDisplayOrder(1);
                chapterRepository.save(chapter1);

                Lesson lesson1 = new Lesson();
                lesson1.setChapter(chapter1);
                lesson1.setTitle("Protons, Neutrons, and Electrons");
                lesson1.setEstimatedMinutes(10);
                lesson1.setDisplayOrder(1);
                lesson1.setContent("Atoms are made of protons and neutrons in the nucleus, with electrons in orbitals around it. The atomic number is the number of protons and determines the element identity.");
            ...
            if (quizRepository.count() == 0) {
                ...
                freeQuiz = quizRepository.findByCreatedByIdOrderByIdDesc(teacher.getId())
                        .stream()
                        .findFirst()
                        .orElse(null);
            }
            ...
            if (assignmentRepository.count() == 0 && freeQuiz != null) {
                ...
                assignment.setDueAt(LocalDateTime.now().plusDays(7));
